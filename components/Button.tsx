...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: "bg-primary-600 hover:bg-primary-500 text-white shadow-[0_0_15px_rgba(14,165,233,0.3)] focus:ring-primary-500",
    secondary: "bg-secondary-600 hover:bg-secondary-500 text-white shadow-[0_0_15px_rgba(16,185,129,0.3)] focus:ring-secondary-500",
